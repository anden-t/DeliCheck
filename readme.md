...
<br/>
<br/>
**ЕСЛИ ВЫ РАНЕЕ ЗАХОДИЛИ НА САЙТ, ТО НЕОБХОДИМО НАЖАТЬ F12 (чтобы открылось окно разработчика), НАЖАТЬ ПРАВОЙ КНОПКОЙ МЫШИ ПО ЗНАЧКУ "Обновить страницу" И ВЫБРАТЬ ПУНКТ "Очистка кеша и жесткая перезагрузка". ТАК ВЫ ПОЛУЧИТЕ АКТУАЛЬНУЮ ВЕРСИЮ ПРОЕКТА.**
<br/>
<br/>
