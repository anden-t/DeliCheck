...
<br/>
1. НАЖАТЬ F12 (чтобы открылось окно разработчика)
2. НАЖАТЬ ПРАВОЙ КНОПКОЙ МЫШИ ПО ЗНАЧКУ "Обновить страницу"
3. ВЫБРАТЬ ПУНКТ "Очистка кеша и жесткая перезагрузка". 
<br/>
