...
Протестировать работу приложения: https://deli-check.ru/ или [Инструкция по запуску](#Инструкция по запуску)
-
...
## Возможности приложения:
 ...
 На ней пользователь видит все чеки, которые с ним разделили либо он из загрузил. Можно посмотреть подробную информацию о каждом чеке, кликнув на него
