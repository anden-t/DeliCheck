...
namespace DeliCheck.Services
{
    ...
    public interface IAuthProvider
    {
        ...
        Task<RegisterResult> RegisterAsync(string username, string email, string phoneNumber, string password, string firstName, string lastName, bool randomAvatar = true, long? vkId = null);
